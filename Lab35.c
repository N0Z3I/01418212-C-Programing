...
void randomArray(int A[5][5][5], int B[125], int rows, int cols, int depth);
void sortArray(int B[125], int totalElements, int choice);
...
int main()
{
    ...
    do
    {
        ...
        randomArray(A, B, rows, cols, depth);
        index = 0;
        ...
        sortArray(B, totalElements, choice);
